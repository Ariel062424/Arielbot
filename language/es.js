...
const translations = {
    ...
    notext: 'Repita agregando un texto a mi bot',
    ...
    search: (value) => `Ingrese lo que quiere buscar en *${value}*`,
    ...
    privateH: 'Este comando solo se puede usar en el chat *privado del Bot de ari-bot*',
